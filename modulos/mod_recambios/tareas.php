...
// Incluimos clase objeto de Recambio.
include_once ("./ObjetoRecambio.php");
...
$pulsado = $_POST['pulsado'];
 ...
 switch ($pulsado) {
	...
	if (isset($_POST['id'])){
		...
		$respuesta = $ObjRecambio->CopiarDescripcion($id,$DatosRefCruzadas,$prefijoJoomla,$BDWebJoomla);
